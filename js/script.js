...
function calcularSueldo() {
    ...
    // Consumo API gratiuta para agregar un usuario al JSON (simulando que es el usuario logeado en casa de tenes una api para login)
    ...
    // Valida que todos los compos tengan datos. 
    if (!fecha && sueldoBase === 0 || totalVentas === 0) {
        ...
        swal({
            title: "¿Desea realizar el cálculo?",
            text: "Se realizara el cálculo con los importes ingresados",
            icon: "warning",
            buttons: ["Cancelar", true],
            dangerMode: true,
        })
            .then((willCalculo) => {
                // Si se acepta, procede a calcular.
                if (willCalculo) {
                    ...
                    swal("¡Se realizó el cálculo correctamente!", {
                        icon: "success",
                    });
                }
            });
